...
#         'rmw,foo,bar,expected_lines',
#         [
#             (rmw_cyclonedds_cpp)
#         ]
# )
# def test_rmw_environment_variables(rmw: str,foo: str, bar: str, expected_lines: str) -> None:
#     os.environ[foo] = bar
...
#     expected_report.add_to_report(f'{rmw} environment variables', expected_lines)
#     assert environment_report.name == expected_report.name
#     assert environment_report.items == expected_report.items
#     assert environment_report == expected_report
