...
#include "ros2cli_test_interfaces/msg/detail/short_varied_nested__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: short_varied
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2cli_test_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_ShortVaried(
  ...
  if (is_plain) {
    ...
    using DataType = ros2cli_test_interfaces::msg::ShortVariedNested;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: short_varied
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2cli_test_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_key_ShortVaried(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
static size_t _ShortVariedNested__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ShortVariedNested(full_bounded, is_plain, 0);
...
{
  return &ros2cli_test_interfaces::msg::typesupport_fastrtps_cpp::_ShortVariedNested__handle;
}
