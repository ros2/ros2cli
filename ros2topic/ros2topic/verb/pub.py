...
def publisher(
    ...
    # TODO(clalancette): This is broken because the msg that is passed in doesn't have timestamp_fields anymore,
    # so updating the fields in the message won't work.
