...
static const _ShortVariedNested_type_support_symbol_names_t _ShortVariedNested_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2cli_test_interfaces, msg, ShortVariedNested)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2cli_test_interfaces, msg, ShortVariedNested)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros2cli_test_interfaces, msg, ShortVariedNested)() {
  return &::ros2cli_test_interfaces::msg::rosidl_typesupport_c::ShortVariedNested_message_type_support_handle;
}
